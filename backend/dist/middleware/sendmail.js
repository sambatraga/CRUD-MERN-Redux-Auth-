...
var sendmail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var testAccount, transporter, pieceJointe, message;
    var _a, _b, _c, _d;
        ...
        switch (_e.label) {
            ...
            case 1:
                ...
                pieceJointe = {
                    ...
                    contentType: "image/".concat((_d = ((_c = req.file) === null || _c === void 0 ? void 0 : _c.mimetype)) === null || _d === void 0 ? void 0 : _d.split("/")[1])
                };
                message = __assign(__assign({}, req.body), { html: "<h1>".concat(req.body.text, "</h1>"), attachments: [pieceJointe] });
                // console.log(message)
